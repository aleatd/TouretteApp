...
//  SindromeTouretteApp
//
//  Created by benedetta zaccaro on 03/03/25.
//
...
let esercizi: [Exercise] = [
    ...
    Exercise(bodyPart: "Leg", exercise: "Tense your glutes.", titleExercise: "Tense Glutes"),
...
struct ExerciseView : View {
    ...
    var body: some View {
        let filteredExercises = esercizi.filter { $0.bodyPart == nameBodyPart }
